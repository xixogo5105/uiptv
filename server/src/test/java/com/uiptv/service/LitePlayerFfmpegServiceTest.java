...
class LitePlayerFfmpegServiceTest {
    ...
    void chooseStrategy_prefersCopyForTransportStreams() {
        assertEquals(COPY, LitePlayerFfmpegService.chooseStrategy("http://example.test/live?extension=ts", false, false));
    }

    @Test
    void chooseStrategy_keepsHlsPlaybackDirectUntilCompatibilityFallbackIsForced() {
        assertEquals(DIRECT, LitePlayerFfmpegService.chooseStrategy("http://example.test/index.m3u8", false, false));
    }
    ...
    void chooseStrategy_keepsUnsupportedHevcTransportStreamDirectWithoutTranscodeSupport() {
        ...
        assertEquals(DIRECT, LitePlayerFfmpegService.chooseStrategy("http://example.test/live?extension=ts", probe, false, false));
    }

    @Test
    void chooseStrategy_keepsLikelyDirectMp4PlaybackDirect() {
        assertEquals(DIRECT, LitePlayerFfmpegService.chooseStrategy("http://example.test/video.mp4", false, false));
    }
    ...
    void chooseStrategy_keepsUnsupportedHevcMp4DirectWithoutTranscodeSupport() {
        ...
        assertEquals(DIRECT, LitePlayerFfmpegService.chooseStrategy("http://example.test/video.mp4", probe, false, false));
    }
    ...
    void chooseStrategy_usesCopyWhenCodecsAreCompatibleButContainerIsNotDirect() {
        ...
        assertEquals(COPY, LitePlayerFfmpegService.chooseStrategy("http://example.test/video.mkv", probe, false, false));
    }
    ...
    void chooseStrategy_keepsUnsupportedVideoCodecDirectWhenContainerNeedsCompatibilityFallback() {
        ...
        assertEquals(DIRECT, LitePlayerFfmpegService.chooseStrategy("http://example.test/video.mkv", probe, false, false));
    }
}
