...
public class PingStalkerPortal {
    private static final String DOCUMENT_URL_REPLACE_PREFIX = "document.URL.replace(pattern,";
    ...
    public static String parsePortalApiServer(String jsFileContents, String url) {
        ...
        try {
            ...
            AppLog.addErrorLog(PingStalkerPortal.class, "pingParseError: " + e.getMessage());
        }
