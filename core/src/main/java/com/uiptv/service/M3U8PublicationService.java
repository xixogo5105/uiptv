...
import static com.uiptv.util.M3uPlaylistUtils.*;
...
public class M3U8PublicationService {
    ...
    public PlaylistAccount getPlaylist(String accountId) {
        ...
        try {
            ...
            AppLog.addErrorLog(M3U8PublicationService.class, "Failed to load playlist for account '" + account.getAccountName() + "'");
