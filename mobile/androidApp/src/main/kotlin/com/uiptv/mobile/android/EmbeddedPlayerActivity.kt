...
class EmbeddedPlayerActivity : Activity() {
    ...
    private fun targetFromIntent(): PlaybackTarget? {
        ...
        return PlaybackTarget(
            ...
            drmType = intent.getStringExtra(NativePlayerActivity.EXTRA_DRM_TYPE).orEmpty(),
            drmLicenseUrl = intent.getStringExtra(NativePlayerActivity.EXTRA_DRM_LICENSE_URL).orEmpty(),
            clearKeysJson = intent.getStringExtra(NativePlayerActivity.EXTRA_CLEAR_KEYS_JSON).orEmpty(),
            inputstreamAddon = intent.getStringExtra(NativePlayerActivity.EXTRA_INPUTSTREAM_ADDON).orEmpty(),
            manifestType = intent.getStringExtra(NativePlayerActivity.EXTRA_MANIFEST_TYPE).orEmpty(),
