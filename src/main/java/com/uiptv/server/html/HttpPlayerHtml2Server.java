...
public class HttpPlayerHtml2Server implements HttpHandler {
    public static final String CHANNEL_HTML_TEMPLATE = getWebServerRootPath() + File.separator + "play2.html";
