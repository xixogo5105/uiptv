...
public class HttpPlayerHtmlServer implements HttpHandler {
    public static final String CHANNEL_HTML_TEMPLATE = getWebServerRootPath() + File.separator + "play.html";
