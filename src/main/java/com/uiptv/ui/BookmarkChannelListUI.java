package com.uiptv.ui;
        ...
        public class BookmarkChannelListUI extends HBox {
            private SearchableTableViewWithButton bookmarkTable = new SearchableTableViewWithButton();
            ...
            public void refresh() {
                ...
                list.forEach(i -> catList.add(new BookmarkItem(new SimpleStringProperty(i.getDbId()), new SimpleStringProperty(i.getChannelName()),
                        new SimpleStringProperty(i.getChannelId()), new SimpleStringProperty(i.getCmd()), new SimpleStringProperty(i.getAccountName()), new SimpleStringProperty(i.getCategoryTitle()), new SimpleStringProperty(i.getServerPortalUrl()), new SimpleStringProperty(i.getChannelName() + " (" + i.getAccountName() + ")"), new SimpleStringProperty(i.getCategoryId()))));
            ...
            private void applyCategoryFilter() {
                ...
                if (selectedTab != null) {
                    ...
                    List<BookmarkItem> filteredList = BookmarkService.getInstance().read().stream()
                            .filter(bookmark -> (selectedCategory == null || "All".equals(selectedCategory.getName()) || selectedCategory.getId().equals(bookmark.getCategoryId())) &&
