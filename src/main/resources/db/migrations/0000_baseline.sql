...
(
    ...
    TEXT,
    accountPagePasswordHash
    TEXT,
    allowedStbTypesJson
    TEXT,
    allowedStbTypesForLocalRecordingJson
    TEXT,
    preferredStbType
    TEXT
);
...
(
    ...
    source
    TEXT,
    seriesCategorySnapshot
    TEXT,
    seriesChannelSnapshot
    TEXT,
...
CREATE TABLE IF NOT EXISTS PublishedM3uSelection
(
    id
    INTEGER
    PRIMARY
