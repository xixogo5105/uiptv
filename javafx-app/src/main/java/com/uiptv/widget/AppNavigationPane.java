...
public class AppNavigationPane extends TabPane {
    ...
    private Node createNavigationGraphic(String labelText, String iconPath) {
        ...
        item.setMinSize(38, 38);
        item.setPrefSize(38, 38);
        item.setMaxSize(38, 38);
        ...
        hitbox.setMinSize(50, 42);
        hitbox.setPrefSize(50, 42);
        hitbox.setMaxSize(50, 42);
        return hitbox;
    }

    public static String findAccessibleText(Node root) {
        if (root == null) {
            return null;
        }
