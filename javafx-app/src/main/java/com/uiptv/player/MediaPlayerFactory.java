...
public class MediaPlayerFactory {
    ...
    static void handleVlcInitFailure(Throwable t) {
        ...
        // Best-effort show notification if available
        try {
            Class<?> notifClass = Class.forName("com.uiptv.widget.AppNotificationCenter");
            notifClass.getMethod("showError", String.class, Runnable.class).invoke(null, message, null);
